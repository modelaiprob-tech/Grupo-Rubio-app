...
// ============================================
// Estado de trabajadores en una fecha
// ============================================
async function estadoTrabajadores(fecha) {
  if (!fecha) {
    throw { status: 400, error: 'Falta parámetro: fecha' };
  }
...
// ============================================
// Informe de horas por trabajador
// ============================================
async function horasTrabajador(trabajadorId, mes, año) {
  if (!trabajadorId || !mes || !año) {
    throw { status: 400, error: 'Faltan parámetros: trabajadorId, mes, año' };
  }
...
// ============================================
// Informe de horas por cliente
// ============================================
async function horasCliente(clienteId, mes, año) {
  if (!clienteId || !mes || !año) {
    throw { status: 400, error: 'Faltan parámetros: clienteId, mes, año' };
  }
...
// ============================================
// Calendario empresa por cliente
// ============================================
async function calendarioEmpresa(clienteId, fechaInicio, fechaFin) {
  if (!clienteId || !fechaInicio || !fechaFin) {
    throw { status: 400, error: 'Faltan parámetros: clienteId, fechaInicio, fechaFin' };
  }
  ...
  // 3. Obtener IDs unicos de trabajadores que trabajan en esos centros
    ...
    fechas.forEach(fecha => {
      ...
      if (ausencia) {
        ...
        if (asignacionesDia.length > 0) {
          ...
          const centrosNombres = [...new Set(asignacionesDia.map(a => a.centro.nombre))].join(', ');

          fila.dias[fechaStr] = {
            codigo: 'X',
            estado: 'TRABAJA',
            centro: centrosNombres,
            horario: horarios,
            color: 'verde'
          };
        } else {

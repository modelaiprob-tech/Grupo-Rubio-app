...
CREATE TABLE "categorias" (
    ...
    "recargo_nocturno" DECIMAL(5,2) NOT NULL DEFAULT 25,
    "recargo_festivo" DECIMAL(5,2) NOT NULL DEFAULT 75,
    "recargo_extra" DECIMAL(5,2) NOT NULL DEFAULT 75,
    "recargo_extra_adicional" DECIMAL(5,2) NOT NULL DEFAULT 100,
    "plus_transporte" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "plus_peligrosidad" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "activo" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "centros_trabajo" (
    ...
    "horarioCierre" TEXT,
    "tipo_horario_limpieza" TEXT NOT NULL DEFAULT 'FLEXIBLE',
    "activo" BOOLEAN NOT NULL DEFAULT true,
    "notas" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "tipos_ausencia" (
    ...
    "porcentaje_cobro" DECIMAL(5,2) NOT NULL DEFAULT 100,
    "usa_tramos" BOOLEAN NOT NULL DEFAULT false,
    "tramos_json" TEXT,
    "base_calculo" TEXT NOT NULL DEFAULT 'SALARIO_BASE',
    "dias_carencia" INTEGER NOT NULL DEFAULT 0,
    "tope_diario_euros" DECIMAL(10,2),
    "pagador" TEXT NOT NULL DEFAULT 'EMPRESA',
    "incluye_domingos" BOOLEAN NOT NULL DEFAULT true,
    "incluye_festivos" BOOLEAN NOT NULL DEFAULT true,
    "dias_maximo" INTEGER,
    "requiere_justificante" BOOLEAN NOT NULL DEFAULT false,
    "tipo_justificante" TEXT NOT NULL DEFAULT 'MEDICO',
    "requiere_alta_medica" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "asignaciones" (
    ...
    "origen_horario_fijo_id" INTEGER,
    "origen" TEXT NOT NULL DEFAULT 'PLANIFICACION',
...
-- CreateIndex
CREATE INDEX "asignaciones_trabajador_id_fecha_idx" ON "asignaciones"("trabajador_id", "fecha");

-- CreateIndex
CREATE INDEX "asignaciones_centro_id_fecha_idx" ON "asignaciones"("centro_id", "fecha");
